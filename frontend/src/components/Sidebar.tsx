    ...
    >
      ...
      <div className="flex justify-between items-center mb-1">
        ...
        <div className="flex gap-1">
          ...
          <button
            onClick={toggleTheme}
            className="flex items-center justify-center w-6 h-6 text-gray-500 hover:text-primary-600 bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded transition-colors cursor-pointer"
            title={themeMode === "light" ? t("common.themeLight") : themeMode === "dark" ? t("common.themeDark") : t("common.themeSystem")}
          >
            {themeMode === "light" ? (
