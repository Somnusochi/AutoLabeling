    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3 text-sm">
        ...
        <span className="text-gray-400 text-xs">
          ...
          {video.totalFrames != null &&
            t("videoPanel.totalFramesText", { count: video.totalFrames })}
        </span>
        {keyframes.length > 0 && (
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <label className="flex items-center gap-1 text-xs text-gray-500">
          ...
          <span className="w-12 text-gray-700">
            {ssimThreshold >= 1 ? t("videoPanel.ssimClose") : `SSIM ${ssimThreshold.toFixed(2)}`}
          </span>
        </label>
        ...
        {keyframes.length > 0 && (
          ...
          >
            {loadingAll
              ? t("common.loading")
              : t("videoPanel.loadAll", { count: keyframes.length })}
          </button>
        )}
      </div>
        ...
        <>
          ...
          {keyframes.length > 12 && (
            ...
            >
              {expanded
                ? t("common.collapse")
                : t("videoPanel.expandAll", { count: keyframes.length })}
            </button>
          )}
        </>
      )}
